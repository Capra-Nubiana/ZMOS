...
INSERT INTO "new_Member" ("avatarUrl", "createdAt", "email", "googleId", "id", "name", "passwordHash", "tenantId", "updatedAt") SELECT "avatarUrl", "createdAt", "email", "googleId", "id", "name", "passwordHash", "tenantId", "updatedAt" FROM "Member";
DROP TABLE "Member";
